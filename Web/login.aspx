...
<div class="container">
		...
		<div class="col-md-8 account-top">
                <asp:TextBox ID="TextBox2" runat="server" placeholder="用户名:"></asp:TextBox>
                <br /><br />
                <asp:TextBox ID="TextBox3" runat="server" placeholder="密码："></asp:TextBox>
		...
		<div class="col-md-4 left-account ">
			...
			<a href="register.aspx" class="create">注册</a>
<div class="clearfix"> </div>
		</div>
	<div class="clearfix">
